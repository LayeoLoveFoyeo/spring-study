...
public class StandardServletEnvironment extends StandardEnvironment implements ConfigurableWebEnvironment {
	 ...
	 */
	/**
	 * 将servletContextInitParams、servletConfigInitParams及环境变量和系统配置初始化PropertySource配置存放到PropertySources中
	 *  servletContextInitParams和servletConfigInitParams为Object对象，环境变量和系统配置为真实的变量和配置
	 * @param propertySources
	 * standard adj 正常的、普通的、标准的、通用的
	 * 			n 水平、规格、规范
